      ...
      <Container>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#424242] max-w-2xl mx-auto">
            Evidence-based recommendations to help you maintain healthy blood
            pressure through diet, lifestyle, and monitoring.
          </p>
        </div>
            ...
            <div className="bg-green-50 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs text-[#4CAF50] bg-green-100 px-2 py-1 rounded">
                    Rich in potassium
                  </span>
                </div>
            ...
            <div className="bg-red-50 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs text-[#F44336] bg-red-100 px-2 py-1 rounded">
                    High sodium content
                  </span>
                </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-blue-50 p-6 rounded-xl mb-8">
            <p className="text-center text-[#424242]">
              <strong>Important:</strong> Consult with your healthcare provider
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-[#424242] mb-8 max-w-3xl mx-auto">
            The Dietary Approaches to Stop Hypertension (DASH) eating plan is
