...
export const IconMap = {
  ...
  utensils: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3v18l9-9m0 0l9 9V3" />
    </svg>
  ),
...
export const Icon: React.FC<{ name: keyof typeof IconMap; className?: string }> = ({ name, className = "w-6 h-6" }) => {
